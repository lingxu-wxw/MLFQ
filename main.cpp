...
int user_job5(void *arg) {
    int time = *(int *)arg;
    cout << "JOB 5: " << "run for " << time << "seconds" << endl;
    sleep(1);
    return time;
}
...
int main(int argc, char **argv) {
    ...
    attr4->arrivetime = 18;
    attr4->executetime = 2;
    attr4->executeremain = 2; 

    thread_attr *attr5 = new thread_attr();
    attr5->name = "Ellen";
    attr5->job = user_job5;
    attr5->priority = PRIORITY_HIGH;
    attr5->quota = periods[PRIORITY_HIGH];
    attr5->quotaremain = periods[PRIORITY_HIGH];
    attr5->arrivetime = 20;
    attr5->executetime = 2;
    attr5->executeremain = 2;
    ...
    cout << "JOB 5: arrive time: " << attr5->arrivetime << "s, execute time: " << attr5->executetime << "s" << endl;
    cout << "------------------------------" << endl;
